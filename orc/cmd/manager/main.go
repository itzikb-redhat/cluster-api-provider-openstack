...
func main() {
	...
	flag.IntVar(&scopeCacheMaxSize, "scope-cache-max-size", 10,
	...
	if err := orccontrollers.SubnetController(
		...
		setupLog.Error(err, "unable to create controller", "controller", "ORCSubnet")
		os.Exit(1)
	}
	...
	if err := orccontrollers.RouterController(
		...
		setupLog.Error(err, "unable to create controller", "controller", "ORCRouter")
		os.Exit(1)
	}
	...
	if err := orccontrollers.PortController(
		...
		setupLog.Error(err, "unable to create controller", "controller", "ORCPort")
		os.Exit(1)
	}
