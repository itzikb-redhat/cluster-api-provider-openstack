...
func (in *NetworkResourceStatus) DeepCopyInto(out *NetworkResourceStatus) {
	*out = *in
	...
	if in.Segments != nil {
		...
		*out = make([]NetworkSegment, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkSegment) DeepCopyInto(out *NetworkSegment) {
	*out = *in
	if in.ProviderNetworkType != nil {
		in, out := &in.ProviderNetworkType, &out.ProviderNetworkType
		*out = new(string)
		**out = **in
	}
	if in.ProviderPhysicalNetwork != nil {
		in, out := &in.ProviderPhysicalNetwork, &out.ProviderPhysicalNetwork
		*out = new(string)
		**out = **in
	}
	if in.ProviderSegmentationID != nil {
		in, out := &in.ProviderSegmentationID, &out.ProviderSegmentationID
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkSegment.
func (in *NetworkSegment) DeepCopy() *NetworkSegment {
	if in == nil {
		return nil
	}
