...
func (in *PortStatus) DeepCopyInto(out *PortStatus) {
	*out = *in
	...
	in.PortStatusExtra.DeepCopyInto(&out.PortStatusExtra)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortStatusExtra) DeepCopyInto(out *PortStatusExtra) {
	*out = *in
	if in.NetworkID != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortStatusExtra.
func (in *PortStatusExtra) DeepCopy() *PortStatusExtra {
	if in == nil {
		return nil
	}
	out := new(PortStatusExtra)
	in.DeepCopyInto(out)
	return out
}
