...
func (obj flavorActuator) GetOSResourceByStatusID(ctx context.Context) (*flavors.Flavor, error) {
	if obj.Status.ID == nil {
		return nil, nil
	}
	return obj.osClient.GetFlavor(ctx, *obj.Status.ID)
}

func (obj flavorActuator) GetOSResourceByImportID(ctx context.Context) (*flavors.Flavor, error) {
	...
	return obj.osClient.GetFlavor(ctx, *obj.Spec.Import.ID)
}
