...
func getOSResourceFromObject(ctx context.Context, log logr.Logger, orcObject *orcv1alpha1.Flavor, osClient osclients.ComputeClient) (f *flavors.Flavor, err error) {
	switch {
