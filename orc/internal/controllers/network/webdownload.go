...
func (r *orcNetworkReconciler) canWebDownload(ctx context.Context, orcImage *orcv1alpha1.Image, imageClient osclients.ImageClient) (bool, error) {
...
func (r *orcNetworkReconciler) webDownload(ctx context.Context, orcImage *orcv1alpha1.Image, imageClient osclients.ImageClient, glanceImage *images.Image) error {
	log := ctrl.LoggerFrom(ctx)
