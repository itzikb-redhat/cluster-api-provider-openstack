...
func (r *orcNetworkReconciler) hashVerifier(ctx context.Context, orcImage *orcv1alpha1.Image, expectedValue string) hashCompletionHandler {
...
func (r *orcNetworkReconciler) downloadProgressReporter(ctx context.Context, orcImage *orcv1alpha1.Image, glanceImage *images.Image, contentLength int64) progressReporter {
	log := ctrl.LoggerFrom(ctx)
...
func (r *orcNetworkReconciler) uploadImageContent(ctx context.Context, orcImage *orcv1alpha1.Image, imageClient osclients.ImageClient, glanceImage *images.Image) (err error) {
	log := ctrl.LoggerFrom(ctx)
