...
func (obj networkActuator) GetOSResourceByStatusID(ctx context.Context) (*networkExt, error) {
	if obj.Status.ID == nil {
		return nil, nil
	}
	return getNetworkByID(ctx, obj.osClient, *obj.Status.ID)
}

func (obj networkActuator) GetOSResourceByImportID(ctx context.Context) (*networkExt, error) {
	...
	return getNetworkByID(ctx, obj.osClient, *obj.Spec.Import.ID)
}
